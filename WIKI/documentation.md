...
* **File Collections:** Specific pages (Home, About, Purpose, Ethos, Forge), allowing editing of hero headers, grid blocks, and customizable call-to-actions dynamically.
